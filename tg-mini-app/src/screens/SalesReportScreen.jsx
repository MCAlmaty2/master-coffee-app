...
export const MONTHS = [
  ...
  { key: '2026-07', label: 'Июль 2026',      short: 'Июл', idx: 3, weeks: ['01-05.07','06-12.07','13-19.07','20-26.07','27-31.07'] },
  { key: '2026-08', label: 'Август 2026',    short: 'Авг', idx: 4, weeks: ['01-08.08','09-15.08','16-22.08','23-29.08','30-31.08'] },
  { key: '2026-09', label: 'Сентябрь 2026', short: 'Сен', idx: 5, weeks: ['01-06.09','07-13.09','14-20.09','21-27.09','28-30.09'] },
  { key: '2026-10', label: 'Октябрь 2026',  short: 'Окт', idx: 6, weeks: ['01-04.10','05-11.10','12-18.10','19-25.10','26-31.10'] },
  { key: '2026-11', label: 'Ноябрь 2026',   short: 'Ноя', idx: 7, weeks: ['01-08.11','09-15.11','16-22.11','23-29.11','30.11'] },
  { key: '2026-12', label: 'Декабрь 2026',  short: 'Дек', idx: 8, weeks: ['01-06.12','07-13.12','14-20.12','21-27.12','28-31.12'] },
];
              ...
              return (
                <tr key={p.id} style={{ background: p.highlight ? 'var(--mc-active-item)' : 'transparent' }}>
                  ...
                  <td style={{ padding: '5px 6px', color: 'var(--mc-muted)', fontSize: 10, borderBottom: '1px solid var(--mc-border-light)', textAlign: 'center' }}>
                    {!isRev && plan > 0 ? Math.round(plan / 4) : '—'}
                  </td>
